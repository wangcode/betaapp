...
const common = {
    baseUrl: process.env.FABU_BASE_URL || "https://127.0.0.1:8090", //baseUrl应用请求的url地址,比如https://fabu.love
    port: process.env.FABU_PORT || "8090", //server运行的端口
    apiPrefix: 'api',
    ...
    dbName: process.env.FABU_DB_NAME || "betaapp", //数据库名称
